    ...
    ***************************************************************************** */
    ...
    var NzInputGroupComponent = /** @class */ (function () {
        ...
        NzInputGroupComponent.prototype.ngAfterContentInit = function () {
            ...
            }), operators.flatMap(function () { return listOfInputChange$; }), operators.map(function (list) { return list.some(function (input) { return input.disabled; }); }), operators.takeUntil(this.destroy$))
